...
uq_methods = ['GPS']
uq_metrics = call_UQ_methods(uq_methods, models, test_loader_tta=test_loader_tta, device=device, optim_metric='balanced_accuracy', num_classes=2, correct_predictions=correct_predictions, incorrect_predictions=incorrect_predictions, correct_predictions_calibration=correct_predictions_calibration, incorrect_predictions_calibration=incorrect_predictions_calibration, image_normalization=True, aug_folder='/mnt/data/psteinmetz/archive_notebooks/Documents/medMNIST/gps_augment_breastmnist', swarmplot=True)